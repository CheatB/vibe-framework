...
### vps-second, vps-n8n, vps-secondbrain
...
VPS-MAIN (31.128.42.135)
  🟢 zachot-bot      — Up 3 days    — :8443
  🟢 zachot-db       — Up 3 days    — :5432
  ⚪ Диск: 45% (12G/25G)
  ⚪ RAM: 1.2G / 4G
  ⚪ Load: 0.15

VPS-SECOND
  🟢 grambotica-api  — Up 7 days    — :3000
  🔴 grambotica-worker — Exited 2h ago
  ⚪ Диск: 67% (8G/12G)
...
Проблемы: 1 сервис упал (grambotica-worker на vps-second)
```
