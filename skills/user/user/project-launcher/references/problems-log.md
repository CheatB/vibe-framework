...
```markdown
## 2026-01-15 | project-1 | Task-2.3 | PostgreSQL Connection Pooling
...
✓ Найдено решение из project-1 (2026-01-15)
...
```
❌ Плохо:
## 2026-01-15 | project-1 | Database Error
...
```
User: Какие проблемы были в проекте project-1?

Claude:
Фильтрую по ProjectName = project-1...
...
3. project-1: Redis connection timeout
```
